...
def help():
   ...
   print(verde+'Example > python2 D0nwTube.py playlist-mp3 https://www.youtube.com/playlist?list=PLQimmOQ9bzurCStHdAoBnZeRyzESSsc7q\n')
   print(verde+'Example > python2 D0nwTube.py -mp4 https://www.youtube.com/watch?v=txmvb7tbAxs&t=57s')
   print(verde+'Example > python2 D0nwTube.py playlist-mp4 https://www.youtube.com/playlist?list=PLQimmOQ9bzurCStHdAoBnZeRyzESSsc7q\n')   
   print(' ')
